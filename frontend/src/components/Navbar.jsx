...
const Navbar = () =>{
    ...
    return(
        ...
        xl:mx-32">
            ...
            <h1 className="w-32 sm:w-44 cursor-pointer sm:text-[px] text-[35px] font-bold 
                text-primary bg-gradient-to-r from-[#217bfe] to-[#8B5CF6] bg-clip-text text-transparent" onClick={()=> navigate("/")}>AI BLog </h1>
